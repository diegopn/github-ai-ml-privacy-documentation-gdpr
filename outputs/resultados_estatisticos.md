...
- Linhas de entrada: **328**.
- Repositórios com licença SPDX/OSI aprovada: **328**.
- Pares completos: **328**.
...
| Pré 1 → pós 0 | 1 |
| Pré 0 → pós 1 | 16 |
| Diferença de proporções pós−pré | 4.6% |
| Odds ratio pareado com correção de Haldane | 11.000 |
| p exato bicaudal | 0.000275 |
